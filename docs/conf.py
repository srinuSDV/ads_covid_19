...
latex_documents = [
    ('index',
     ...
     u"Sreenivasulu Subaiya Chappidi", 'manual'),
]
...
man_pages = [
    ('index', 'ads_covid-19', u'ADS_COVID-19 Documentation',
     [u"Sreenivasulu Subaiya Chappidi"], 1)
]
...
texinfo_documents = [
    ('index', 'ads_covid-19', u'ADS_COVID-19 Documentation',
     u"Sreenivasulu Subaiya Chappidi", 'ADS_COVID-19',
     'Data Analysis on COVID 19 Data from various countries', 'Miscellaneous'),
]
